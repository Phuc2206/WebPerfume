...
function checkErrorToScroll() {
    ...
    function h(n, t) {
        ...
        if ($province = $("select[data-address-type='province'][data-address-zone='" + n + "']"), $province) {
            for (u = ['<option value="" hidden>Chưa chọn<\/option>'], f = 0; f < i.length; f++) {
                if (r = i[f], r.id == t) {
    ...
    function s(n, t, i) {
        ...
        if (r) {
            ...
            for (s = f.filter(function(n) {
                ...
                }), e = ['<option value="" hidden>Chưa chọn<\/option>'], o = 0; o < s.length; o++) {
                if (u = s[o], u.id == i) {
    ...
    function r(n, t, i) {
        ...
        if (r) {
            ...
            for (f = ['<option value="" hidden>Chưa chọn<\/option>'], s = e.filter(function(n) {
    ...
    function c() {
        ...
        } : fetch("/User/json/addresses.json").then(function(n) {
            return n.json()
        }).then(function(n) {
            i = n.provinces;
            f = n.districts;
